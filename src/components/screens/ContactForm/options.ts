...
const aktyubinskayaOblast = [
	{
		value: 'Акюбинская область (все районы и города)',
		label: 'Акюбинская область (все районы и города)'
	}
]

const almatinskayaOblast = [
	{
		value: 'Алматинская область (все районы и города)',
		label: 'Алматинская область (все районы и города)'
	}
]
...
const atyrauskaya = [
	{
		value: 'Атырауская (все районы и города)',
		label: 'Атырауская (все районы и города)'
	}
]

const vostochnoKazakhstanskayaOblast = [
	{
		value: 'Восточно-Казахстанская область (все районы и города)',
		label: 'Восточно-Казахстанская область (все районы и города)'
	}
...
const kostanajskaya = [
	{ value: 'Костанайская область (все районы и города)', label: 'Костанайская область (все районы и города)' },
]

const kyzylordinskaya = [
	{ value: 'Кызылординская область (все районы и города)', label: 'Кызылординская область (все районы и города)' },
]

const mangystauskaya = [
	{ value: 'Мангыстауская область (все районы и города)', label: 'Мангыстауская область (все районы и города)' },
]

const pavlodarskaya = [
	{ value: 'Павлодарская область (все районы и города)', label: 'Павлодарская область (все районы и города)' },
]

const severoKazakhstanskayaOblast = [
	{ value: 'Северо-Казахстанская область (все районы и города)', label: 'Северо-Казахстанская область (все районы и города)' },
]

const turkestanskaya = [
	{ value: 'Туркестанская область (все районы и города)', label: 'Туркестанская область (все районы и города)' },
]
...
const yuko = [
	{ value: 'Южно-Казахстанская область (все районы и города)', label: 'Южно-Казахстанская область (все районы и города)' },
]
